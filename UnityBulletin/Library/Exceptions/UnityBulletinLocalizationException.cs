...
{
    /// <summary>
    /// Unity Bulletin Localization Exception class.
    /// </summary>
    public class UnityBulletinLocalizationException : Exception
    {
        /// <summary>
        /// UnityBulletinLocalizationException.
        /// </summary>
        public UnityBulletinLocalizationException() : base() { }

        /// <summary>
        /// UnityBulletinLocalizationException.
        /// </summary>
        /// <param name="message">string; exception message</param>
        public UnityBulletinLocalizationException(string message) : base(message) { }
        ...
        public UnityBulletinLocalizationException(string message, Exception innerException) : base(message, innerException) { }
    }
}