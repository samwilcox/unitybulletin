...
{
    /// <summary>
    /// Queries factory section handler class.
    /// </summary>
    public sealed class QueriesFactorySectionHandler : ConfigurationSection
    {
        /// <summary>
        ...
        public string ConnectionString
        {
            get
            {
                ...
                {
                    throw new UnityBulletinDatabaseException("Connection string was not found in the database configurations.", e);
                }
            }
    }
}